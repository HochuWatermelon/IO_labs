...
#define MBR_SIZE MBRDISK_SECTOR_SIZE
...
#define head4size(s) (((s) % CYL_SIZE) / HEAD_SIZE)  // calculates the number of heads required to address the partition
#define cyl4size(s) ((s) / CYL_SIZE)

#define SIZE_10M (10 * 2048)
#define SIZE_20M (20 * 2048)
#define SIZE_30M (30 * 2048)
...
{
	{
		...
		end_head: head4size(SIZE_20M - 1) + 1,
	...
	{
		boot_type: 0x00,
		start_head: head4size(SIZE_20M),
		start_sec: sec4size(SIZE_20M) + 1,
		start_cyl: cyl4size(SIZE_20M),
		part_type: 0x05, // extended partition type
		end_sec: sec4size(SIZE_20M + SIZE_30M - 1) + 1,
		end_head: head4size(SIZE_20M + SIZE_30M - 1),
		end_cyl: cyl4size(SIZE_20M + SIZE_30M - 1),
		abs_start_sec: SIZE_20M + 1,
		sec_in_part: SIZE_30M
	}
};
static unsigned int def_log_part_br_abs_start_sector[] = {SIZE_20M + 1, SIZE_20M + SIZE_10M + 1, SIZE_20M + SIZE_10M + SIZE_10M + 1};
	...
	{
		{
			...
			start_cyl: 0x0, 
			part_type: 0x83,
			end_head: head4size(SIZE_10M - 1),
			end_sec: sec4size(SIZE_10M - 1) ,
			end_cyl: cyl4size(SIZE_10M - 1),
			abs_start_sec: 0x0,
			sec_in_part: SIZE_10M
		},
		
		{
			boot_type: 0x00,
			start_head: head4size(SIZE_10M) + 1,
			start_sec: sec4size(SIZE_10M),
			start_cyl: cyl4size(SIZE_10M),
			part_type: 0x05,
			end_head: head4size(SIZE_10M + SIZE_10M - 1) + 1,
			end_sec: sec4size(SIZE_10M + SIZE_10M - 1),
			end_cyl: cyl4size(SIZE_10M + SIZE_10M - 1),
			abs_start_sec: SIZE_10M,
			sec_in_part: SIZE_10M + 1
		}
	},
	{
		{
		...
		{
			boot_type: 0x00,
			start_head: head4size(SIZE_10M + SIZE_10M) + 1,
			start_sec: sec4size(SIZE_10M + SIZE_10M),
			start_cyl: cyl4size(SIZE_10M + SIZE_10M),
			part_type: 0x05,
			end_head: head4size(SIZE_10M + SIZE_10M + SIZE_10M - 1) + 1,
			end_sec: sec4size(SIZE_10M + SIZE_10M + SIZE_10M - 1),
			end_cyl: cyl4size(SIZE_10M + SIZE_10M + SIZE_10M - 1),
			abs_start_sec: SIZE_10M + SIZE_10M ,
			sec_in_part: SIZE_10M + 1
		}
	},
	{
